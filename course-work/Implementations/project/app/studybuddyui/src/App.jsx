...
function App() {
    ...
    function checkIfMatched() {
        if (!matchId) {
            ...
            x = document.getElementById("DeleteChatDiv");
            if (x) x.style.display = "none";
            ...
            .then(data => {
                ...
                if (data.chats && data.chats.length > 0) {
                    data.chats.forEach(chat => {
                        console.log(`Chat with: ${chat.other_student_name}`);
                        console.log("Messages:");
                        chat.messages.forEach(msg => {
                            console.log(`[${msg.created_at}] (${msg.sender_id}) ${msg.message}`);
                        });
                        console.log(chat.match_id);
    ...
    return (
        <div>
            <table >
                <tr>
                    <td><h1>StudyBuddy</h1></td>
                    <td><div id="DeleteAccDiv" class="hidden">
