...
3.	Позволен технологичен стак
    ...
    2.	C# .NET, JavaScript, TypeScript по избор
...
Всеки проект трябва да е качен в някакво публично репозитори (github.com/pkyurkchiev/distributed-applications-se-pt/)
